...
type SyllableScreenProps = {
    ...
    /** Audio que se reproduce cuando la respuesta es correcta */
    successAudio: AVPlaybackSource;
    /** Audio que se reproduce cuando la respuesta es incorrecta */
...
export default function SyllableScreen({
    ...
    const requestAudioPermission = async (): Promise<boolean> => {
        ...
        const granted = await PermissionsAndroid.request(
            PermissionsAndroid.PERMISSIONS.RECORD_AUDIO,
            {
                ...
                message: 'Necesitamos acceso al micrófono para dictar.',
    ...
    // Toca un audio de feedback (correcto o incorrecto)
    const playFeedback = async (file: AVPlaybackSource) => {
        ...
        // opcional: navegar tras el feedback correcto
    ...
    // Compara e invoca el audio correspondiente
    ...
    // Reproducción de práctica (igual que antes)
