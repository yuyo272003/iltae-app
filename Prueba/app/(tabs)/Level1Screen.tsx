...
const lessons = [
    {
        ...
        audioFile: require('@assets/audio/lecciones/nivel1/intro.wav'),
    },
    {
        id: 'leccion1',
    ...
    {
        id: 'leccion5',
        title: 'Sílabas combinadas',
        type: 'leccion',
        image: require('@assets/images/lecciones/nivel1/silabas_combinadas.png'),
        audioFile: require('@assets/audio/lecciones/nivel1/intro.wav'),
    },
];
