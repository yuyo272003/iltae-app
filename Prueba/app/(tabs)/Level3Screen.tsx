...
const lessons = [
    {
        ...
        carpeta: 'bl',
        type: 'leccion',
        image: require('@assets/images/lecciones/nivel3/combinacion.png'),
        audioFile: require('@assets/audio/levels/nivel3/leccion1.wav'),
    },
    {
        id: 'leccion2',
        ...
        carpeta: 'a',
        type: 'leccion',
        image: require('@assets/images/lecciones/nivel3/combinadas.png'),
        audioFile: require('@assets/audio/levels/nivel3/leccion2.wav'),
    },
    {
        id: 'leccion3',
        ...
        carpeta: 'global',
        type: 'leccion',
        image: require('@assets/images/lecciones/nivel3/palabras.png'),
        audioFile: require('@assets/audio/levels/nivel3/leccion3.wav'),
    },
];
...
export default function Level3Screen() {
    ...
    // OFFSET: 6 lecciones Nivel1 + 3 lecciones Nivel2 = 9
    const levelOffset = 9;
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <TouchableOpacity
                    onPress={() => playAudioGlobal(require('@assets/audio/levels/nivel3/nivel3.wav'))}
                ...
                ListFooterComponent={
                    <View style={styles.footerContainer}>
                        ...
                        <TouchableOpacity
                            onPress={async () => {
                                await stopAudioGlobal();
                                await playAudioGlobal(require('@assets/audio/levels/nivel3/introduccionGuia.wav'));
                            }}
