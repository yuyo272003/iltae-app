...
export default function Leccion1() {
    return (
        <LetterScreenWithDrawing
            ...
            practiceAudio={require('@assets/audio/levels/nivel1/lessons/G/Gboard.wav')}
            // @ts-ignore
            onTopBack={() => router.push('/(tabs)//Level1Screen')}
            // @ts-ignore
            onBottomBack={() => router.push('/(tabs)/niveles//nivel1/leccion3/Gg/Glearn')}
            // @ts-ignore
            onNext={() => router.push('/(tabs)/niveles/nivel1/leccion3/Gg/Gsilabas')}
