...
export default function Leccion1() {
    return (
        <LetterScreenWithDrawing
            ...
            practiceAudio={require('@assets/audio/levels/nivel1/lessons/B/Bboard.wav')}
            // @ts-ignore
            onTopBack={() => router.push('/(tabs)//Level1Screen')}
            // @ts-ignore
            onBottomBack={() => router.push('/(tabs)/niveles//nivel1/leccion3/Bb/leccion')}
            // @ts-ignore
            onNext={() => router.push('/(tabs)/niveles/nivel1/leccion3/Bb/Bsilabas')}
