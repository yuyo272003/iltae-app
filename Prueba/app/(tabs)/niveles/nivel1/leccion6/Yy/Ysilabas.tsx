...
export default function Leccion1() {
    return (
        <SyllableScreen
            ...
            practiceAudio={require('@assets/audio/lecciones/nivel1/lessons/Y/Ysilabaslearn.wav')}
            syllablesAudio={require('@assets/audio/lecciones/nivel1/lessons/Y/Ysilabas.wav')}
            // @ts-ignore
