...
export default function Leccion1() {
    ...
    return (
        <SyllableScreen
            ...
            practiceAudio={require('@assets/audio/lecciones/nivel1/lessons/N/Nsilabaslearn.wav')}
            syllablesAudio={require('@assets/audio/lecciones/nivel1/lessons/N/Nsilabas.wav')}
            // @ts-ignore
