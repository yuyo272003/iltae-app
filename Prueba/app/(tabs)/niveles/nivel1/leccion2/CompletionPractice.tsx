...
export default function Leccion1() {
    ...
    return (
        <WordDragGame
            slides={[
                {
                    ...
                    correctLetters: ['m', 'n'],
                    options: ['m', 'n', 'ñ'],
                    audio: require('@assets/audio/lecciones/nivel1/lessons/A/A2.wav')
                },
                {
            ...
            firstSlideBackRoute="/(tabs)/niveles/nivel1/leccion2/N2palabra" // Custom route for back button on first slide
