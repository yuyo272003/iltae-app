...
export default function Leccion1() {
    return (
        <LetterScreenWithDrawing
            ...
            practiceAudio={require('@assets/audio/lecciones/nivel1/lessons/N/Nboard.wav')}
            // @ts-ignore
            onTopBack={() => router.push('/(tabs)//Level1Screen')}
            // @ts-ignore
            onBottomBack={() => router.push('/(tabs)/niveles//nivel1/leccion2/Nlearn')}
            // @ts-ignore
            onNext={() => router.push('/(tabs)/niveles/nivel1/leccion2/Nsilabas')}
