...
export default function Leccion1() {
    ...
    return (
        <SyllableScreen
            ...
            practiceAudio={require('@assets/audio/lecciones/nivel1/lessons/Ñ/Ñsilabasinstruccion.wav')}
            syllablesAudio={require('@assets/audio/lecciones/nivel1/lessons/Ñ/Ñsilabas.wav')}
            // @ts-ignore
