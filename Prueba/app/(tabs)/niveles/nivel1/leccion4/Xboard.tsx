...
export default function Leccion1() {
    return (
        <LetterScreenWithDrawing
            ...
            practiceAudio={require('@assets/audio/lecciones/nivel1/lessons/X/Xboard.wav')}
            // @ts-ignore
            onTopBack={() => router.push('/(tabs)//Level1Screen')}
            // @ts-ignore
            onBottomBack={() => router.push('/(tabs)/niveles//nivel1/leccion4/Xlearn')}
            // @ts-ignore
            onNext={() => router.push('/(tabs)/niveles/nivel1/leccion4/Xsilabas')}
