...
export default function ScreenWord() {
  const images = [
    ...
    { id: '2', src: require('@/assets/images/lecciones/nivel2/guante.png'), audio: require('@/assets/audio/levels/nivel2/audios_lesson1/guante.wav'), isCorrect: true },
    ...
    { id: '6', src: require('@/assets/images/lecciones/nivel2/hueso.png'), audio: require('@/assets/audio/levels/nivel2/audios_lesson1/hueso.wav'),isCorrect: true},
  ];
