...
export default function Leccion1() {
    ...
    const imageSourcesArray = [
        require('@assets/images/lecciones/nivel3/leccion1/cl/CLmayusc.png'),
        require('@assets/images/lecciones/nivel3/leccion1/cl/CLminusc.png'),
    ];
    ...
    return (
        <LetterScreenWithDrawing
            ...
            practiceAudio={require('@assets/audio/levels/nivel3/audios_lesson1/cl/CLboard.wav')}
            // @ts-ignore
            onTopBack={() => router.push('/(tabs)//Level3Screen')}
            // @ts-ignore
            onBottomBack={() => router.push('/(tabs)/niveles/nivel3/leccion1/cl/firstScreen')}
            // @ts-ignore
            onNext={() => router.push('/(tabs)/niveles/nivel3/leccion1/cl/CLpalabra')}
        />
    );
}